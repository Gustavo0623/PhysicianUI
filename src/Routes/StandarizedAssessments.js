...
export default function StandarizedAssessments() {
    ...
    return (
        <div className="customization-page">
            <div className="resource-container">
                <h1>Add Standarized Assessments.</h1>
                ...
                <button className="progress-bar" onClick={handleClick}>
                    <div className="fill-effect" style={{ width: isFilling ? '66%' : '33%' }}></div>
                    <p className="progress-bar-label">Trauma-Informed Tools</p>
